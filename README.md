...
Nesse repositório estão exemplos e dicas sobre o uso da biblioteca Numba para aceleração de de scripts em Python.
Esse exemplos, em sua maioria, são baseados nos tutorais da documentação oficial do **Numba** (a qual é excelente!). Logo, os códigos aqui presentes só por sua vez uma releitura com um pouco da minah experiência pessoal com o uso dos recursos da biblioteca.
